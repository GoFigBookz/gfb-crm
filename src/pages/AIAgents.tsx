...
const agentTypes = [
  ...
  { value: "tax", label: "Tess — Tax Specialist", description: "Corporate (T2) & personal (T1) tax, HST/GST returns, year-end tax prep, instalments, CRA correspondence. Prepares for your sign-off — never files." },
  { value: "cfo", label: "Jade — Fractional CFO", description: "Cash-flow forecasting, profitability & KPI analysis; flags ways to run leaner or grow revenue and surfaces upsell opportunities." },
  { value: "social_media_manager", label: "Skye — Social / Marketing", description: "Content calendar, on-brand post drafts, repurposes wins/tips, schedules & engages to grow the audience." },
