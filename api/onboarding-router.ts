...
export const onboardingRouter = createRouter({
  ...
  staffSubmit: staffQuery
    .input(z.object({
      ...
      payrollBonuses: z.boolean().default(false),
      payrollPhoneAllowance: z.boolean().default(false),
      payrollReimbursements: z.boolean().default(false),
      payrollRevenueShare: z.boolean().default(false),
      payrollCraComparison: z.boolean().default(false),
      ...
      usesShopify: z.boolean().default(false),
  ...
  updateRecord: staffQuery
    .input(z.object({
      ...
      usesTouchBistro: z.boolean().optional(), usesPayPal: z.boolean().optional(), usesWise: z.boolean().optional(), usesShopify: z.boolean().optional(),
    ...
    .mutation(async ({ input }) => {
      ...
      const onbKeys = ["businessLegalName", "craBusinessNumber", "primaryContactName", "primaryContactEmail",
        ...
        "usesPayPal", "usesWise", "usesShopify", "salesEntryFrequency", "qboSoftwareTier", "qboSoftwareWholesale", "qboPayrollWholesale",
